...
public:
    ...
    bool set_prezzo_totale(double prezzo);
    bool is_confermata() const; 

    static bool reset_statistiche();
    static bool aggiorna_statistiche_da_load(std::string destinazione, std::string pacchetto, double costo, std::string client_code);
    static bool set_prenotazioni_create(int n);
